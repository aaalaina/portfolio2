...
const Hero = () => {
  ...
  return <Box sx={{mt: 8, mb: 12, p: 2, maxWidth:"1200px", mx: "auto"}} id="home">
    <Typography sx={{color: "white", textAlign: "Center", mb: 2}} variant="h6">
      Welcome to my portfolio! I'm Alaina Harris.
    </Typography>

  <CustomTitle variant="h1">
    I enjoy <span style={{ color: "#b8e8e8" }}>creating</span>{" "} and <span style={{ color: "#b8e8e8" }}>designing</span> new web applications.
  </CustomTitle>
