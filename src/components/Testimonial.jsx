...
const Testimonial = () => {
  ...
  <Box sx={{
    ...
    mx: 3
      ...
      <Typography variant="body1" sx={{color: "#2d334a", mb: 2}}>
      ...
      <span style={{ color: "black", fontWeight: "bold" }}>
        ...
        <span style={{ color: "#c63f17" }}> - Tech Lead</span>
      </Typography>
      <FormatQuoteIcon
        style={{
          position: "absolute",
  ...
  <Box sx={{
    ...
    mx: 3
      ...
      <span style={{ color: "black", fontWeight: "bold" }}>
        ...
        <span style={{ color: "#c63f17" }}> - PD Lead</span>
      </Typography>
      <FormatQuoteIcon
        style={{
          position: "absolute",
  ...
  <Box sx={{
    ...
    mx: 3
      ...
      <span style={{ color: "black", fontWeight: "bold" }}>
        ...
        <span style={{ color: "#c63f17" }}> - Senior Tech Instructor</span>
      </Typography>
      <FormatQuoteIcon
        style={{
          position: "absolute",
